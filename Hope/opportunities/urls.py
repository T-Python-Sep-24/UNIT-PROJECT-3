...
urlpatterns = [
    ...
    path('opportunity/<int:id>/', views.opportunity_detail_view, name='opportunity_detail_view'),
    ...
    path("apply/<int:id>/", views.apply_to_opportunity_view, name="apply_to_opportunity_view"),
